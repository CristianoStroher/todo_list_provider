...
//construtor da classe
  ...
  Widget build(BuildContext context) {
    return InkWell( //envolve o container em um InkWell para adicionar um evento de clique
      onTap: () => context.read<HomeController>().findTasks(filter: taskfilter), //chama o método para buscar as tarefas e atualizar a lista de tarefas
